<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="Project.Profile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <br /><br />
    <table id="tblProfile" runat="server" align="center" style="height: 100px; width: 1000px;">
        <tr>
            <td>
                <asp:GridView  runat="server" ID="GridProfile" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" >
